...
| FA-21 | **Imagen de categoría**, y una imagen de marca más grande que el logo | Hoy la marca tiene `logo_url` (RF-18) y la categoría no tiene imagen ninguna: se muestra como texto —chips del encabezado, accesos de la portada, filtros—. Sumarles una foto abre secciones que hoy no se pueden dibujar: una portada con categorías ilustradas, una franja de marcas, una cabecera por categoría. **Un logo y una portada no son lo mismo** y por eso van juntos acá: el logo es una marca gráfica, suele venir con transparencia y se muestra chico; la portada es una foto, es apaisada y se muestra grande. Comparten la canalización de F2.2 pero no la tabla de tamaños de §9.2, que está pensada para la foto de un producto |
