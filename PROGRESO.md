...
|---|---|---|
| **E4 enlaza al inicio del panel hasta que exista F7.1** | `FUNCTIONAL-SPEC.md` RF-30 | RF-30 pide «enlace directo al detalle en el panel» y ese detalle es F7.1, dos fases después. Armar `/admin/ordenes/<id>` por adelantado daría 404 en todos los avisos de la ventana, y además fija una dirección que todavía no eligió nadie. El email **no depende del enlace para servir**: lleva el pedido entero para que se pueda decidir sin abrir nada, y el enlace es para lo que el email no puede hacer — cambiar el estado. Es el mismo criterio con el que F5.8 dejó el bloque de bajas con el enlace apagado hasta F7.9 |
