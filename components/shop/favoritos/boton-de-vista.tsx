 ...
 * se ven los recuadros, y con las tarjetas, la lista. La etiqueta lo dice con
 * palabras —«Ver como tarjetas»— para el lector de pantalla, y el tooltip
 * para quien no reconozca el ícono.
 *
